...
public class ExecutorsNewSingleThreadExecutorDemo extends Demo2 {

    public static void main(String[] args) throws NoSuchFieldException, IllegalAccessException {
        ExecutorService executorService = Executors.newSingleThreadExecutor();

        Field threadPoolExecutorField = (executorService.getClass()).getSuperclass().getDeclaredField("e");
        threadPoolExecutorField.setAccessible(true);
        ThreadPoolExecutor threadPoolExecutor = (ThreadPoolExecutor) threadPoolExecutorField.get(executorService);
